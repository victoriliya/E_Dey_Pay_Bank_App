...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CGLogistics.Model.Category", b =>
                {
                    b.HasOne("CGLogistics.Model.Product", null)
                        .WithOne("Category")
                        .HasForeignKey("CGLogistics.Model.Category", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CGLogistics.Model.OrderDetails", b =>
                {
                    b.HasOne("CGLogistics.Model.Order", null)
                        .WithOne("OrderDetails")
                        .HasForeignKey("CGLogistics.Model.OrderDetails", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CGLogistics.Model.Product", b =>
                {
                    b.HasOne("CGLogistics.Model.Order", null)
                        .WithOne("Product")
                        .HasForeignKey("CGLogistics.Model.Product", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
