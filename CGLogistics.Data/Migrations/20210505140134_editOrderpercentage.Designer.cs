...
namespace CGLogistics.Data.Migrations
{
    ...
    [Migration("20210505140134_editOrderpercentage")]
    partial class editOrderpercentage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CGLogistics.Model.Order", b =>
                {
                    b.HasOne("CGLogistics.Model.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CGLogistics.Model.OrderDetails", null)
                        .WithMany("Orders")
